    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_update', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('option', models.ManyToManyField(related_name='optionResume', to='siteweb.Optionresume')),
            ],
            options={
                'verbose_name': 'Resume',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_update', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('categorie', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='categorie_papier', to='siteweb.categoriepapier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_update', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=True)),
                ('option', models.ManyToManyField(related_name='detailApropos', to='siteweb.Optionapropos')),
            ],
            options={
